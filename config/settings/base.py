...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='btp_algeria_db'),
        'USER': config('POSTGRES_USER', default='btp_user'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='btp_password'),
...
LOGOUT_REDIRECT_URL = 'public_landing'
